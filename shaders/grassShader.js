...
const fragmentShader = `
	...
	void main() {
		...
		// Yellow
		//vec3 baseColour = vec3(0.2, 0.2, 0.12);
		//vec3 tipColour = vec3(0.8, 0.8, 0.576);

		// Green
		vec3 baseColour = vec3(0.17, 0.2, 0.12);
		vec3 tipColour = vec3(0.69, 0.8, 0.576);
		...
		float fogIntensity = (distToCamera - fogNear) * (1.0 / (fogFar - fogNear));
		fogIntensity = max( 0.0, min( 1.0, fogIntensity) );

		diffuseColour = mix(diffuseColour, fogColour, fogIntensity);
